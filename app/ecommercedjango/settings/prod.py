...
#cambiamos a false entonces pasa a produccion  en DEBUG y allowed host con * permite que conecte
#todas las IPS
...
STATIC_URL = '/static/'
#para estaticos ruta de archivos estaticos asi para produccion
